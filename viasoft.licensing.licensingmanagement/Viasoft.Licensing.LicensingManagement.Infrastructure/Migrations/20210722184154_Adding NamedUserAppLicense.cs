...
{
    public partial class AddingNamedUserAppLicense : Migration
    {
        private readonly ISchemaNameProvider _schemaNameProvider;

        public AddingNamedUserAppLicense(ISchemaNameProvider schemaNameProvider)
        {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NamedUserAppLicenses", x => x.Id);
                },
