...
{
    public partial class AddingBundles : Migration
    {
        private readonly ISchemaNameProvider _schemaNameProvider;

        public AddingBundles(ISchemaNameProvider schemaNameProvider)
        {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropTable(
                name: "Bundle", schema:_schemaNameProvider.GetSchemaName());
        }
    }
}
