...
{
    [Endpoint("Viasoft.Licensing.LicensingManagement.LicensedTenantUpdatedMessage", "Viasoft.Licensing.LicensingManagement")]
    public class LicensedTenantUpdatedCommand : ICommand, IInternalMessage
    {
