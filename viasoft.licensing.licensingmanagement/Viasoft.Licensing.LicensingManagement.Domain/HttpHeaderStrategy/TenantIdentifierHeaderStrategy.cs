...
{
    public class TenantIdentifierHeaderStrategy: IHttpHeaderStrategy
    {
        private readonly string _tenantIdentifier;
        private readonly IAmbientDataCallOptionsResolver _callOptionsResolver;

        public TenantIdentifierHeaderStrategy(string tenantIdentifier, IServiceProvider serviceProvider)
        {
        ...
        public Dictionary<string, string> GetHeaders()
        {
            ...
            if (!headers.TryGetValue("TenantId", out _))
            {
